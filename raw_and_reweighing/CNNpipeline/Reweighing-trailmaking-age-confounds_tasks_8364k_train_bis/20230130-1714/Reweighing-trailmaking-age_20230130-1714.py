...
common_model_settings = {
    ...
    "rescale_X": True, 
    "show_grad_flow" : True,
    "weight_debiased" : True, 
    "cf_name" :"age_binned",
    "data_hold" : '/ritter/share/projects/gonzalo/h5files/confounds_tasks_3460k_holdout_bis.h5',
 #   "label_encoding":True,
   # "n_classes":1,
 #  "label_encoding_confound":True,
}
...
class Config:
    ...
    H5_FILES = [
        ...
        #"/ritter/share/data/UKBB_2020/Confounds_tasks26k.h5",  
        #"/ritter/share/data/UKBB_2020/confounds_tasks_4k.h5", 
        #'/ritter/share/data/UKBB_2020/h5filesconfounds_tasks_26k_v2.h5',
        #'/ritter/share/projects/gonzalo/h5files/confounds_tasks_8k.h5',
        ...
        '/ritter/share/projects/gonzalo/h5files/confounds_tasks_8364k_train_bis.h5'
    ]
...
################# Fine-tuning with the parameters loaded from videos ('pretrain' : True, 'feature_extraction' : False (default))
        ...
        'trail_making_avg_duration_binary': 
            dict(
                TASK_TYPE='classif_binary',
                METRICS=[accuracy_score, explained_deviance, mz_rsquare],
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "ResNet50_trail_making_binned", # unique name to identify this model
                     "rescale_Y" : True,
...
"""
            ...
            dict(
                ...
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "ResNet50_alc__categorical", # unique name to identify this model
                    "model_params":{'out_classes':1, 'task_type':'classif_binary', 'freeze_feature_extractor': False,
                                   'pretrained_model':'/ritter/share/data/UKBB_2020/trained_model/r3d50_K_200ep.pth'}, 
                    "criterion":  nn.BCEWithLogitsLoss,
        ...
        'alc_int_freq': 
            dict(
                ...
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "ResNet50_alc_int_freq_regression", # unique name to identify this model
                    "rescale_Y" : True,
      ...
      'sex': 
        # (3) Training settings specific to this label
            ...
            dict(
                ...
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "ResNet50_fluid_intelligence", # unique name to identify this model
                    "rescale_Y" : True,
                    "model_params":{'task_type':'regression', 'freeze_feature_extractor': False,}, 
                    "criterion":nn.MSELoss,"criterion_params":{},
                    "balance_loss_weights":True,
