...
common_model_settings = {
    ...
    "cf_name" :"total_brain_volume_binned",
...
################# Fine-tuning with the parameters loaded from videos ('pretrain' : True, 'feature_extraction' : False (default))
        ...
        'sex': 
            dict(
                ...
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "ResNet50_sex", # unique name to identify this model
                    "model_params":{'out_classes':1, 'task_type':'classif_binary', 'freeze_feature_extractor': False, 'pretrained_model':'/ritter/share/data/UKBB_2020/trained_model/r3d50_K_200ep.pth'}, 
