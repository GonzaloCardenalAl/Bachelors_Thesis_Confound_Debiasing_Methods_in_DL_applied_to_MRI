...
common_model_settings = {
    "model": FCN_3D_hooked,        
    "batch_size": 20, "num_epochs": 120, "earlystop_patience": 20,
...
################# Fine-tuning with the parameters loaded from videos ('pretrain' : True, 'feature_extraction' : False (default))
        ...
        'highalc': 
            dict(
                ...
                METRICS=[accuracy_score,balanced_accuracy_score, mz_rsquare, explained_deviance],
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "FCN_highalc", # unique name to identify this model
