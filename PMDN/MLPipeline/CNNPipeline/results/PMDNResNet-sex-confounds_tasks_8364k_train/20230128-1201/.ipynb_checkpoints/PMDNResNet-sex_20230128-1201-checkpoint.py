...
common_model_settings = {
    ...
    "batch_size": 12, "num_epochs": 120, "earlystop_patience": 15,
...
class Config:
    ...
    H5_FILES = [
        #"/ritter/share/projects/gonzalo/h5files/old_files_after_transfer_learning_project/h5files5tasks256_mooddis.h5", 
...
################# Fine-tuning with the parameters loaded from videos ('pretrain' : True, 'feature_extraction' : False (default))
        ...
        'sex': 
            dict(
                ...
                MODEL_SETTINGS =[
                    {**common_model_settings,
                    "model_name": "PMDN_sex", # unique name to identify this model
                    "model_params" : {"dataset_size" : 8364, "batch_size" : 12, 
